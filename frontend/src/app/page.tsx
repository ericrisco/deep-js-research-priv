        ...
        <main className="min-h-screen bg-black text-white px-4 py-12">
            <div className="max-w-4xl mx-auto">
                <div className="flex justify-center mb-12">
                    <svg role="img" width="120" height="120" viewBox="0 0 750 750" className="text-[#FFE500]">
                        <defs>
                            <clipPath id="a">
                ...
                <h2 className="text-4xl text-center mb-16">
                    <span className="bg-[#FFE500] text-black px-4">¡gratis!</span><br/>
                    <span className="text-2xl text-white/70 mt-4 block">¿200$? No gracias, OpenAI</span>
                </h2>

                {!isConnected && (
                    <div className="text-center text-red-500 mb-4">
                        Conectando al servidor de investigación...
                    </div>
                )}
                ...
                <ConceptInput onSubmit={startResearch} isProcessing={isProcessing} />
                <ThinkingProcess isVisible={isProcessing} currentStep={currentStep} />
                <ResultDisplay result={result} isVisible={!isProcessing && result !== ''} />
                <SourcesList sources={sources} isVisible={!isProcessing && sources.length > 0} />
            </div>
        </main>
    );
}
